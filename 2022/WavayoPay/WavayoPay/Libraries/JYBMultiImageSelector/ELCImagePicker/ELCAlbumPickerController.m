        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                UIAlertView * alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"str_guide", comment: "")
                                       message:NSLocalizedString(@"str_fail_get_photo", comment: "") delegate:nil cancelButtonTitle:NSLocalizedString(@"str_confirm", comment: "") otherButtonTitles:nil];
                [alert show];
...
- (void)reloadTableView
{
	...
	[self.navigationItem setTitle:NSLocalizedString(@"str_add_photo", comment: "")];
}
