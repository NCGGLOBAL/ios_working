...
@interface HomeScreen () <UIWebViewDelegate, ZBarReaderDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, PictureSelectDelegate, SubWebViewScreenDelegate> {
...
//    NSString *sUrl = [NSString stringWithFormat:@"%@/%@", kWebSiteUrl, @"m/app/"];    //  http://osaka.wavayo.com/api/
    ...
    NSURL *url = [NSURL URLWithString:kImageUploadUrl];
