...
//        }
        ...
        print("작업 시작")
        do {
            let gif = try UIImage(gifName: "IOS_1242x2208_intro.gif")
            self.splashImageView = UIImageView(gifImage: gif, loopCount: 3) // Will loop 3 times
            self.splashImageView?.frame = self.view.bounds
