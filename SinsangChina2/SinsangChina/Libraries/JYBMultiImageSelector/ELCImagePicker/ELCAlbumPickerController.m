    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"안내" message:@"사진을 불러오지 못했습니다." delegate:nil cancelButtonTitle:@"확인" otherButtonTitles:nil];
                [alert show];
...
- (void)reloadTableView
{
	...
	[self.navigationItem setTitle:@"사진추가"];
}
