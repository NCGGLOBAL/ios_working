...
//  ShortDeal
//
//  Created by 정진만 on 2022/08/07.
//  Copyright © 2022 ncgglobal. All rights reserved.
//
...
class NaviWebViewController: UIViewController, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler {
